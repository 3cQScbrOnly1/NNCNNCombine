...
public:
	inline void initial(ModelParams& model, HyperParams& opts, AlignedMemoryPool* mem = NULL){
		...
		_neural_concat.init(opts.hiddenSize * 3, -1, mem);
...
public:
	...
	inline void forward(const Feature& feature, bool bTrain = false){
		...
		_neural_concat.forward(this, &_max_pooling, &_min_pooling, &_avg_pooling);
		_neural.forward(this, &_neural_concat);
